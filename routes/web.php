...
use App\Http\Controllers\QueuePollController;
...
// ── Public registration — outside auth group, different URL prefix ─────────
//Route::get('/register/patient',  [PatientController::class, 'create'])->name('patients.create');
//Route::post('/register/patient', [PatientController::class, 'store'])->name('patients.store');
Route::get('/register/patient',  [\App\Http\Controllers\PatientController::class, 'create'])->name('patients.create');
Route::post('/register/patient', [\App\Http\Controllers\PatientController::class, 'store'])->name('patients.store');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/analytics/weekly-queue', [AnalyticsController::class, 'weeklyQueue'])
        ->name('analytics.weekly-queue');
    ...
    Route::prefix('queue')->name('queue.')->group(function () {
        ...
        Route::get('/poll/patient',            [QueuePollController::class, 'patientPoll'])->name('poll.patient');
        Route::get('/poll/admin',              [QueuePollController::class, 'adminPoll'])->name('poll.admin');
    });
    ...
    Route::prefix('appointments')->name('appointments.')->group(function () {
        ...
        Route::get('/doctors-by-dept',         [AppointmentController::class, 'doctorsByDept'])->name('doctors-by-dept');
